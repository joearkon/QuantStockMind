...
import { LayoutDashboard, TrendingUp, NotebookPen, Radar, UserCheck, Layers, ListChecks, ScanEye, Gavel, Network, ShieldCheck, Binoculars, Cpu } from 'lucide-react';
...
export const NAV_ITEMS = [
  ...
  { id: 'quant-synergy', label: '量化合力追踪', icon: Cpu }, // NEW
