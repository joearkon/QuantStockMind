...
import { QuantVane } from './components/QuantVane'; 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-9">
              ...
              <Routes>
                ...
                <Route path="/policy-calendar" element={<PolicyCalendar currentModel={selectedModel} currentMarket={selectedMarket} settings={userSettings} onOpenSettings={() => setIsSettingsOpen(true)} />} />
                <Route path="/quant-vane" element={<QuantVane currentModel={selectedModel} currentMarket={selectedMarket} settings={userSettings} onOpenSettings={() => setIsSettingsOpen(true)} />} />
